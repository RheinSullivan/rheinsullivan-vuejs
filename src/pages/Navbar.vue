...
<template>
  <nav class="fixed top-0 left-0 w-full bg-dark backdrop-blur-sm z-20 transition py-1 duration-300 px-2 lg:px-[120px]" ref="navbar">
    <div class="container flex justify-between items-center h-20">
      ...
      >
        <a href="#home" class="text-white hover:text-red lg:pt-2 font-medium" @click="showNavbar = false">Home</a>
        <a href="#about" class="text-white hover:text-red lg:pt-2 font-medium" @click="showNavbar = false">About</a>
        <a href="#project" class="text-white hover:text-red lg:pt-2 font-medium" @click="showNavbar = false">Project</a>
        <a href="#quotes" class="text-white hover:text-red lg:pt-2 font-medium" @click="showNavbar = false">Quotes</a>
        <a
